...
dogname="SiberianhuskyPuppy"

num=1
for i in range(1,510):
    #img파일 가져오기
    path="C:\\Users\\inaee\\Desktop\\MAKERS\\Dog\\REAL\\Siberianhuskypuppy\\"+str(i)+"_Siberianhuskypuppy.jpg"
    ...
    # 이미지 저장하기
    cv2.imwrite("C:\\Users\\inaee\\Desktop\\MAKERS\\Dog\\PADDING\\SiberianhuskyPuppy_size\\"+dogname+"_"+str(num)+".jpg",img_re2)
    num=num+1
    print("완료")
